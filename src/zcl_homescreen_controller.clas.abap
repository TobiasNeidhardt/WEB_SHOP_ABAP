CLASS zcl_homescreen_controller DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC

  GLOBAL FRIENDS zcl_customer_login_controller .
  ...
  PUBLIC SECTION.
    ...
    METHODS: add_buttons_show_position
      ...
      search_selected_product
        RETURNING
          VALUE(rs_selected_product) TYPE zweb_article ,
      on_pbo_cart ,
      on_back ,
      on_leave
        RAISING zcx_webshop_exception_new ,
  ...
  PRIVATE SECTION.
    ...
    METHODS:
      ...
      search_selected_item_in_cart
        RETURNING
          VALUE(rs_selected_item) TYPE zweb_s_cart ,
...
CLASS zcl_homescreen_controller IMPLEMENTATION.
  ...
  METHOD create_alv_for_cart.
    ...
    TRY.
        ...
        me->mo_alv_grid_cart->set_table_for_first_display( EXPORTING  i_structure_name = 'ZWEB_S_CART'
  ...
  METHOD create_alv_for_home_screen.
    ...
    TRY.
        ...
        IF me->mo_container_home_screen IS BOUND AND me->mo_alv_grid_home_screen IS NOT BOUND.
          ...
          me->mo_alv_grid_home_screen->set_table_for_first_display( EXPORTING i_structure_name = 'ZWEB_ARTICLE'
...
*          SET HANDLER me->handle_node_context_menu_sel FOR me->mo_tree.
  ...
  METHOD on_edit_quantity.
    ...
    TRY.
        ...
        IF lv_quantity > 0 AND lv_quantity < lc_max_number_of_product.
          ...
          DATA ls_item_for_cart TYPE zweb_article.
          DATA(ls_item) =  me->search_selected_item_in_cart( ).

          ls_item_for_cart = VALUE zweb_article( article_number = ls_item-article_number
  ...
  METHOD on_order.
    ...
    TRY.
        ...
        ELSE.
          MESSAGE i050(z_web_shop) INTO DATA(ls_msg).
          RAISE EXCEPTION TYPE zcx_webshop_exception_new USING MESSAGE.
        ENDIF.
      CATCH zcx_webshop_exception_new INTO DATA(e_text).
        MESSAGE e_text->get_text( ) TYPE 'S' DISPLAY LIKE 'E'.
  ...
  METHOD on_show_cart.
    ...
    IF me->mo_home_screen_model->mt_cart IS NOT INITIAL.
      ...
      IF mo_cart_view IS NOT BOUND.
        mo_cart_view = NEW zcl_cart_view( io_controller = me ).
      ENDIF.
  ...
  METHOD show_article.
    ...
    IF mo_custom_container_article IS NOT BOUND.
      ...
      mo_alv_grid_article->set_table_for_first_display( EXPORTING i_structure_name = 'ZWEB_ARTICLE'
  ...
  METHOD show_order.
    ...
    IF it_order IS NOT INITIAL.
      IF me->mo_container_show_position IS NOT BOUND.
        ...
        me->mo_alv_grid_show_position->set_table_for_first_display( EXPORTING i_structure_name = 'ZWEB_ORDER'
