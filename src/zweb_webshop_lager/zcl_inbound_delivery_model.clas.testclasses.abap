...
CLASS zcl_inbound_delivery_model DEFINITION LOCAL FRIENDS ltc_idm_warehouse.
...
CLASS zcl_inbound_delivery_model DEFINITION LOCAL FRIENDS ltc_idm_article.
CLASS ltc_idm_article DEFINITION FOR TESTING RISK LEVEL HARMLESS.
  ...
  PRIVATE SECTION.
    ...
    CONSTANTS: lc_logobject        TYPE bal_s_log-object VALUE 'ZSBT',
               lc_subobjec         TYPE bal_s_log-subobject VALUE 'ZUBT',
               lc_customer         TYPE zsbt_customernumber_de VALUE '1',
               lc_article_number_1 TYPE zsbt_artikelnummer_de VALUE '1',
               lc_article_number_2 TYPE zsbt_artikelnummer_de VALUE '2',
