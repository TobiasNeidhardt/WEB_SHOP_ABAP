*"* use this source file for your ABAP unit test classes^
 ...
 CLASS zcl_order_overview_model DEFINITION LOCAL FRIENDS ltc_web_shop_model.                                  .
 ...
 DURATION SHORT.
   ...
   PRIVATE SECTION.
     CONSTANTS: lc_customer_number   TYPE zweb_kd_numr_de VALUE '1',
                lc_order_number      TYPE zweb_order_number VALUE  '1',
 ...
 CLASS ltc_web_shop_model IMPLEMENTATION.
   ...
   METHOD setup.
     ...
     m_cut = NEW zcl_order_overview_model( io_log = NEW zcl_webshop_log( iv_object = 'ZWEB'
                                                                         iv_suobj  = 'ZWEB'  )  ).
   ...
   METHOD get_datatyp_quan.
     ...
     "given
     DATA: lv_value    TYPE  zweb_order_amount VALUE lc_order_amount_1,
   ...
   METHOD edit_position_quan.
     ...
     "given
     DATA: lv_value       TYPE          zweb_order_amount VALUE 4.
     "when
     TRY.
   ...
   METHOD get_positions_check.
     ...
     "given
     DATA: mt_positions TYPE STANDARD TABLE OF zweb_order WITH DEFAULT KEY .
     "when
 ...
 CLASS zcl_order_overview_model DEFINITION LOCAL FRIENDS ltc_web_shop_model_artikel.
 ...
 DURATION SHORT.
   ...
   PUBLIC SECTION.
     DATA: m_cut            TYPE REF TO zcl_order_overview_model,
           lt_order_data    TYPE TABLE OF zweb_article,
           lt_artikel_preis TYPE ltt_artikel_price.

     CLASS-DATA: m_environment TYPE REF TO if_osql_test_environment.
     CONSTANTS: lc_article_number_1 TYPE zweb_article_number VALUE 1,
                lc_price_1          TYPE zweb_price VALUE 20,
                lc_article_number_2 TYPE zweb_article_number VALUE 2,
                lc_price_2          TYPE zweb_price VALUE 10.
